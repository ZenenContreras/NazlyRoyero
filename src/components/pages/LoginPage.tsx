...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white pt-20">
      ...
      <section className="pt-20 bg-white animate-in fade-in duration-500">
        <div className="max-w-lg mx-auto px-4 sm:px-6 text-center">
          ...
          <h2 className="text-base sm:text-lg mb-4 sm:mb-6 max-w-sm mx-auto leading-relaxed animate-in slide-in-from-bottom-4 duration-700 delay-100">
            <span className="text-[#6C7A52] font-semibold">🔐 Accede a tu espacio</span>{" "}
      ...
      <section className="py-6 sm:py-8 bg-white">
        <div className="max-w-md mx-auto px-4 sm:px-6">
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl border border-gray-200 shadow-lg p-4 sm:p-6 animate-in slide-in-from-bottom-6 duration-700 delay-300">
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
              ...
              <div className="animate-in fade-in slide-in-from-bottom-2 delay-400">
                ...
                <input
                  ...
                  className="w-full px-3 py-2.5 sm:px-4 sm:py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#6C7A52] focus:border-transparent transition-all duration-200 text-sm sm:text-base"
              ...
              <div className="animate-in fade-in slide-in-from-bottom-2 delay-500">
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-full px-3 py-2.5 sm:px-4 sm:py-3 pr-10 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#6C7A52] focus:border-transparent transition-all duration-200 text-sm sm:text-base"
              ...
              {/* Remember & Forgot */}
              <div className="flex items-center justify-between animate-in fade-in slide-in-from-bottom-2 delay-600">
              ...
              <div className="animate-in fade-in slide-in-from-bottom-2 delay-700">
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-[#6C7A52] to-[#4F8F8B] text-white px-4 py-2.5 sm:py-3 rounded-xl font-medium hover:shadow-lg transition-all duration-300 text-sm sm:text-base transform hover:scale-105 flex items-center justify-center group"
                >
              ...
              {/* Google Login Button */}
              <div className="animate-in fade-in slide-in-from-bottom-2 delay-750">
                <button
                  type="button"
            ...
            {/* Divider */}
            <div className="mt-6 pt-4 border-t border-gray-100 animate-in fade-in slide-in-from-bottom-2 delay-800">
              ...
              <Link
                to="/registro"
                className="w-full bg-[#4F8F8B]/10 border border-[#4F8F8B] text-[#4F8F8B] px-4 py-2.5 sm:py-3 rounded-xl font-medium hover:bg-[#4F8F8B] hover:text-white transition-all duration-300 text-sm sm:text-base transform hover:scale-105 flex items-center justify-center group"
              >
          ...
          {/* Additional Info */}
          <div className="mt-6 text-center animate-in fade-in slide-in-from-bottom-2 delay-900">
