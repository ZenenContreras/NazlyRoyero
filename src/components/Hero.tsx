    ...
    <section id="inicio" className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-[#A7D3C1]/10 to-[#D9A689]/10 pt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <a
            href="#contacto"
            className="inline-flex items-center bg-[#6C7A52] text-white px-8 py-4 rounded-full text-lg font-medium hover:bg-[#5a6644] transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 group"
          >
