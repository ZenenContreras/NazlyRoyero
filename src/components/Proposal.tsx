...
const Proposal = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-[#A7D3C1]/10 to-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            <h3 className="text-2xl font-medium text-[#6C7A52] mb-6">
            ...
            <div className="space-y-4">
              {targetAudience.map((item, index) => (
                <div key={index} className="flex items-start space-x-3">
                  <CheckCircle className="text-[#4FEF8B] mt-1 flex-shrink-0" size={20} />
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              {services.map((item, index) => (
                <div key={index} className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-[#D9A689] rounded-full mt-3 flex-shrink-0"></div>
                  <p className="text-gray-700 leading-relaxed">{item}</p>
                </div>
              ))}
            </div>
