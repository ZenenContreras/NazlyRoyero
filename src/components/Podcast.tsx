...
const Podcast = () => {
  ...
  return (
    <section id="podcast" className="py-20 bg-gradient-to-br from-[#6C7A52] to-[#5a6644] text-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="text-center mb-16">
          <div className="flex items-center justify-center mb-6">
            <Headphones className="mr-3" size={40} />
        ...
        <div className="space-y-6 mb-12">
          {episodes.map((episode, index) => (
            <div
              key={index}
              className="bg-white/10 backdrop-blur-sm p-6 rounded-2xl hover:bg-white/15 transition-all duration-300 cursor-pointer group"
            >
              <div className="flex items-start space-x-4">
                {/* Play Button */}
                <div className="w-16 h-16 bg-[#4FEF8B] rounded-full flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
                ...
                <div className="flex-1">
                  ...
                  <h3 className="text-xl font-medium text-white mb-3 group-hover:text-[#4FEF8B] transition-colors">
                    {episode.title}
                  </h3>
        ...
        <div className="text-center">
          <a
            href="#"
            className="inline-flex items-center bg-[#4FEF8B] text-gray-900 px-8 py-4 rounded-full text-lg font-medium hover:bg-[#3de076] transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 group"
          >
            Escucha el podcast
